...
export default function HowToReach({ config }: Props) {
  const cards = [
    ...
    { grad: 'linear-gradient(135deg,var(--secondary-deep),var(--secondary-deep))', icon: 'globe', title: 'By Car', body: 'Parking is available near the hospital. Contact us for landmark directions.' },
  ]
  return (
    <section className="reach-section">
      <div className="sec-header">
        ...
        <p className="sec-sub">Multiple ways to get to our hospital.</p>
      </div>
