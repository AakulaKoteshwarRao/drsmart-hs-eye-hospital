...
export default function TeamFAQ({ clinic }: { clinic: ClinicInfo }) {
  ...
  const faqs = [
    ...
    { q: 'Are all doctors available every day?', a: `Consulting doctors have specific days and hours. The lead doctor is available ${clinic.hours}. Please check each doctor schedule or call the hospital for availability.` },
    { q: 'Do the consulting doctors operate at this hospital?', a: 'Consultations happen at our hospital. Surgical procedures are performed at our affiliated hospitals depending on the case.' },
    ...
    { q: 'Is online consultation available with all doctors?', a: 'Online consultation is available with the lead doctor. For consulting doctors, please contact the hospital to check teleconsultation availability.' },
  ]
  return (
