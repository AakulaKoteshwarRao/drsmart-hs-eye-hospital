    ...
    <section className="hero">
      ...
      <div className="hero-image">
        <div className="doctor-photo-wrapper">
          {clinic.heroImage ? (
            <Image src={clinic.heroImage} alt={clinic.city ? `${clinic.name}, ${clinic.city}` : clinic.name} width={800} height={600} style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '16px' }} priority quality={70} sizes="(max-width: 768px) 100vw, 50vw" />
          ) : (
